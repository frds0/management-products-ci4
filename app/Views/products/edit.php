    ...
    <form action="<?= base_url('products/update/' . $product['id']) ?>" method="post">
        <div class="row mt-4">
                ...
                <div class="col-sm-5">
                    <select class="form-select" id="floatingSelectGrid" name="category_id" required>
                        ...
                        <?php foreach ($categories as $key) { ?>
                            <option value="<?= $key['id'] ?>" <?php if ($key['id'] == $product['category_id']): ?> selected <?php endif ?>>
                                <?= $key['category_name'] ?>
                            </option>
                        <?php } ?>
                    </select>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-2">
                    <input type="number" min="0" class="form-control" id="stok" name="stok" value="<?= $product['stok'] ?>" required>
                </div>
            </div>
        </div>
